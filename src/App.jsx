...
function ProtectedRoute({ children, department }) {
  ...
  // If department is specified, wrap with DepartmentProtectedRoute
  if (department) {
    return (
      <DepartmentProtectedRoute requiredDepartment={department}>
        {children}
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/technical" element={
          <ProtectedRoute department="technical">
            <Layout>
              <Technical />
            </Layout>
          </ProtectedRoute>
    ...
    <Route path="/admin-finance/employee-data" element={ 
       ...
       <Route path="/general/mou" element={
        ...
        <Route path="/general/maritime-governance-course" element={
            <ProtectedRoute>
              <MaritimeGovernanceCourse />
            </ProtectedRoute>
          } />

        <Route path="/general/marine-casualty-course" element={
          <ProtectedRoute>
